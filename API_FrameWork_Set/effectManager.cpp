...
HRESULT effectManager::init()
{
	...
	addEffect("destory_sprite", "destory_sprite", 240 * 3, 28 * 3, 240 * 3/8, 28 * 3, 1, 0.5f, 30);
	addEffect("destory_grass_sprite", "destory_grass_sprite", 232 * 3, 43 * 3, 232 * 3/8, 43 * 3, 1, 0.4f, 30);
	addEffect("enemy_death", "enemy_death", 182 * 3, 32 * 3, 182 * 3 / 7, 32 * 3, 1, 0.3f, 30);
