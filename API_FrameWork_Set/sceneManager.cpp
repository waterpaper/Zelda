...
tileMap sceneManager::getCurrentTileMap()
{
	return _currentScene->getTileMap();
}

void sceneManager::setNowFloor(int floor)
{
	_currentScene->setNowFloor(floor);
}

int sceneManager::getNowFloor()
{
	return _currentScene->getNowFloor();
}
